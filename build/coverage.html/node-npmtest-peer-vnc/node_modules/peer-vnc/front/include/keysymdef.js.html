...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-peer-vnc/node_modules/peer-vnc/front/include/keysymdef.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-peer-vnc/node_modules/peer-vnc/front/include/keysymdef.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-peer-vnc/node_modules/peer-vnc/front/include/</a> &#187; keysymdef.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">// This file describes mappings from Unicode codepoints to the keysym values
...
&nbsp;
<span class="fstat-no" title="function not covered" >    function lookup(k) {</span> <span class="cstat-no" title="statement not covered" >return k ? {keysym: k, keyname: keynames ? keynames[k] : k} : undefined; </span>}
    return {
        fromUnicode : <span class="fstat-no" title="function not covered" >function(u) {</span> <span class="cstat-no" title="statement not covered" >return lookup(codepoints[u]); </span>},
        lookup : lookup
    };
})();
&nbsp;
